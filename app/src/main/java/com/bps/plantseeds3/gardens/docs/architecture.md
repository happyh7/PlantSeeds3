# Arkitektur - Trädgård-modulen

## Översikt
Trädgård-modulen följer Clean Architecture-principer med tre huvudlager:
1. Data-lagret
2. Domänlagret
...
- Hanterar relationer mellan trädgårdar och växter

### 2. Domänlagret
- Innehåller affärslogik och domänmodeller
- Definierar repository-interfacet
- Innehåller use cases för trädgårdshantering
- Är oberoende av data- och presentationslagren
- Hanterar trädgårdens egenskaper och zonering
- Definierar relationer mellan trädgårdar och växter
...
- Visar trädgårdens layout och zonering
...
- Tester för trädgårdszonering och klimat 