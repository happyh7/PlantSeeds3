# Utvecklingsguide - Trädgård-modulen
...
- Testa trädgårdszonering och klimat
...
### Lägga till en ny trädgård
1. Skapa GardenEntity
2. Implementera GardenDao-metoder
3. Uppdatera GardenRepository
4. Skapa GardenViewModel
5. Implementera UI-komponenter
6. Skriva tester

### Uppdatera trädgårdszonering
1. Uppdatera GardenState
2. Implementera GardenEvent
